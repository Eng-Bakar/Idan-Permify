...
function WorkerForm() {
    ...
    return <div>
        ...
        <div className="bg-lightBlue w-full h-screen py-12">
            <div className="w-[350px] ml-[38%] shadow-lg h-[470px] rounded-[8px] bg-white ">
                <form className="pt-4">
                    <div className="flex">
                    ...
                    <div className="px-6 ">
                        <div>
                            ...
                            <input value={StartDate} onChange={(event) => setStartDate(event.target.value)} type="date" className="w-[140px] h-[40px] text-deepBlue bg-lightBlue outline-none rounded-[5px] px-2" />
                            <input value={EndDate} onChange={(event) => setEndDate(event.target.value)} type="date" className="w-[140px] h-[40px] text-deepBlue bg-lightBlue outline-none rounded-[5px] px-2 ml-5 mb-1" />
                        </div>
                        <div className="mt-3">
                            <div className="flex mt-1 justify-between">
